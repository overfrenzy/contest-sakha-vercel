  ...
  try {
    ...
    await client.query(
      `CREATE TABLE IF NOT EXISTS Participant (ID INT DEFAULT unique_rowid(), Name STRING, CONSTRAINT primary_key PRIMARY KEY (ID));
       CREATE TABLE IF NOT EXISTS Task (ID INT DEFAULT unique_rowid(), Name STRING, Value VARCHAR, Solved BOOLEAN, CONSTRAINT primary_key PRIMARY KEY (ID));
       ...
       CREATE TABLE IF NOT EXISTS Country (ID INT DEFAULT unique_rowid(), Name VARCHAR, CONSTRAINT primary_key PRIMARY KEY (ID));
       CREATE TABLE IF NOT EXISTS SchoolName (ID INT DEFAULT unique_rowid(), Name VARCHAR, CONSTRAINT primary_key PRIMARY KEY (ID));
       ...
       CREATE TABLE IF NOT EXISTS ContestTasks (ID INT DEFAULT unique_rowid(), Number VARCHAR, CONSTRAINT primary_key PRIMARY KEY (ID));
       ...
       CREATE TABLE IF NOT EXISTS Award (ID INT DEFAULT unique_rowid(), Name VARCHAR, CONSTRAINT primary_key PRIMARY KEY (ID));`
    );
